...
impl Default for HttpServerSettings {
    fn default() -> Self {
        Self {
            enabled: true,
            addr: SocketAddr::from_str("127.0.0.1:8050").expect("valid addr"),
        }
    }
}
...
impl Default for GrpcServerSettings {
    fn default() -> Self {
        Self {
            enabled: true,
            addr: SocketAddr::from_str("127.0.0.1:8051").expect("valid addr"),
        }
    }
}
...
impl Default for MetricsSettings {
    fn default() -> Self {
        Self {
            enabled: false,
            addr: SocketAddr::from_str("127.0.0.1:6060").expect("should be valid url"),
